...
#BSUB -J adam_dp=2e-1_imgaug_simple
...
#BSUB -oo logs/adam_dp=2e-1_imgaug_simple/%J.out 

echo "Starting bash script"

### Make logging directory
mkdir -p logs/adam_dp=2e-1_imgaug_simple/
...
python3 src/models/cheXpert_neural_network_w_argparser.py adam_dp=2e-1_imgaug_simple 0 2e-1 0 1
