...
#BSUB -oo logs/adam_dp=4e-1_imgaug/%J.out 

echo "Starting bash script"

### Make logging directory
mkdir -p logs/adam_dp=4e-1_imgaug/
...
python3 src/models/cheXpert_neural_network_w_argparser.py adam_dp=4e-1_imgaug 0 4e-1 True
