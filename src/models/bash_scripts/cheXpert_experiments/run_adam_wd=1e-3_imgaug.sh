...
#BSUB -oo logs/adam_wd=1e-3_imgaug/%J.out 

echo "Starting bash script"

### Make logging directory
mkdir -p logs/adam_wd=1e-3_imgaug/
...
python3 src/models/cheXpert_neural_network_w_argparser.py adam_wd=1e-3_imgaug 1e-3 0 1
