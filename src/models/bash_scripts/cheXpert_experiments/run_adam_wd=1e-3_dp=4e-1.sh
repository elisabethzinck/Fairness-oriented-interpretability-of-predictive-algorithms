...
#BSUB -oo logs/adam_wd=1e-3_dp=4e-1/%J.out 

echo "Starting bash script"

### Make logging directory
mkdir -p logs/adam_wd=1e-3_dp=4e-1/
...
python3 src/models/cheXpert_neural_network_w_argparser.py adam_wd=1e-3_dp=4e-1 1e-3 4e-1 False
