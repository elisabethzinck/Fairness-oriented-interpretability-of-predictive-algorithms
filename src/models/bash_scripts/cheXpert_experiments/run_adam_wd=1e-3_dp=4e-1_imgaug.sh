...
#BSUB -J adam_wd=1e-3_dp=4e-1_imgaug
...
#BSUB -oo logs/adam_wd=1e-3_dp=4e-1_imgaug/%J.out 

echo "Starting bash script"

### Make logging directory
mkdir -p logs/adam_wd=1e-3_dp=4e-1_imgaug/
...
python3 src/models/cheXpert_neural_network_w_argparser.py adam_wd=1e-3_dp=4e-1_imgaug 1e-3 4e-1 True
