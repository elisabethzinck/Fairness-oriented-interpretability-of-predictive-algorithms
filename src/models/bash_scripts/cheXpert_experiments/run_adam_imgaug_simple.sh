...
#BSUB -oo logs/adam_imgaug_simple/%J.out 

echo "Starting bash script"

### Make logging directory
mkdir -p logs/adam_imgaug_simple/
...
python3 src/models/cheXpert_neural_network_w_argparser.py adam_imgaug_simple 0 0 0 1
