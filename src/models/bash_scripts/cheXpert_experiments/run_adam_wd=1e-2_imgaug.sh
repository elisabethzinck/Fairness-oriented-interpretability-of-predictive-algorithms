...
#BSUB -oo logs/adam_wd=1e-2_imgaug/%J.out 

echo "Starting bash script"

### Make logging directory
mkdir -p logs/adam_wd=1e-2_imgaug/
...
python3 src/models/cheXpert_neural_network_w_argparser.py adam_wd=1e-2_imgaug 1e-2 0 True
